...
HANGMAN_PICS = ['''
   ...
   / \ |
      ===''']
words = {
        'Цвета':'красный оранжевый желтый зеленый синий голубой фиолетовый белый черный коричневый розовый серый'.split(), 
...
def playAgain():
    # Эта функция возвращает True, если игрок хочет сыграть еще раз; в противном случае возвращает false
    print('Хотите сыграть еще? (да или нет)')
    return input().lower().startswith('д')


print('В И С Е Л И Ц А v2.0')

difficulty = ' '
while difficulty not in 'ЛСТ':
    print('\nВыберите уровень сложности: Л - Легкий, С - Средний, Т - Тяжелый')
    difficulty = input().upper()
print()
if difficulty == 'Л':
    print('Уровень сложности: Легкий')
if difficulty == 'С':
    print('Уровень сложности: Средний')
    del HANGMAN_PICS[8]
    del HANGMAN_PICS[7]
if difficulty == 'Т':
    print('Уровень сложности: Тяжелый')
    del HANGMAN_PICS[8]
    del HANGMAN_PICS[7]
    del HANGMAN_PICS[5]
    del HANGMAN_PICS[3]
